...
public class ReservationsDBRepo implements ReservationsRepository{

    private final String id_flight;
    private final String id_user;
    private final String id_person;

    public ReservationsDBRepo(String id_flight, String id_user, String id_person) {
