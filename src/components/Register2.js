...
export default function Register2() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (city === '' || street === '') {
            ...
            const loginCall = await fetch('http://localhost:3600/userflat/createorjoinflat', {
                method: 'POST',
                headers: {
            ...
            <div className='home'>
                ...
                <div className='featuredItem' >
                    <div>
                        ...
                        <div className='featuredTitle'>
                            <TextField style={style} id="handleName" onChange={handleName} variant="outlined" label="Name" type='text' fullWidth />
                        </div>
                        <div className='featuredTitle'>
                            <TextField style={style} id="handleCity" onChange={handleCity} variant="outlined" label="City" type='text' fullWidth />
                        </div>
                        <div className='featuredTitle'>
                            <TextField style={style} id="handleStreet" onChange={handleStreet} variant="outlined" label="Street" type='text' fullWidth />
                        </div>
                        <div className='featuredTitle'>
                            <TextField style={style} id="handleCounty" onChange={handleCounty} variant="outlined" label="County" type='text' fullWidth />
                        </div>
