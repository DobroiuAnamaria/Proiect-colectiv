...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (username === '' || password === '') {
            setError([{message: 'Username or password is empty!'}]);
        } else {
    ...
    return (
        <main>
            ...
            <div id="content">
                <header><Avatar style={headerStyle}><AddBusinessIcon /></Avatar></header>
                <Grid align='center' marginTop={10}>
                    <Paper elevation={10} style={paperStyle}>
                        ...
                        <TextField id="userName" label="Name" onChange={handleName} variant="outlined"
                            style={btnStyle} fullWidth />
                        <TextField id="userSurname" label="Surname" onChange={handleSurname} variant="outlined"
                            style={btnStyle} fullWidth />
                        <TextField required id="userUsername" label="Username" onChange={handleUsername} variant="outlined"
                            style={btnStyle} fullWidth />
                        <TextField required id="userPassword" label="Password" onChange={handlePassword}
                            style={btnStyle} type="password" variant="outlined" fullWidth />
                        <TextField required id="userPasswordid" label="Please confirm the password"
                            style={btnStyle} type="password" variant="outlined" fullWidth />
